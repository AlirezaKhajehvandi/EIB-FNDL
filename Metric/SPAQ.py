...
class Demo(object):
	...
	def __init__(self, config, load_weights=True, checkpoint_dir='./Metric/weights/BL_release.pt' ):
		self.config = config
...
def parse_config():
	...
	parser.add_argument('--test_dir', type=str,
					 	# default="./data/outputs/Comparision/Zero_Our_results/original_pre/VV/") # zero
					 	# default="./data/outputs/Comparision/SGZ/VV/") # sgz
					 	# default="./data/outputs/Comparision/SCI_results/all_data/VV/") # sci
					 	default="./data/outputs/Comparision/conf-ff20/VV/") # our
	parser.add_argument('--read_subfolder', type=bool, default=False)
	return parser.parse_args()
# default="./data_metric/our/MEF/")Boat
# default="./data/our_ExDark_result/Bicycle/")
...
# Example run: python -W ignore SPAQ.py --test_dir /home/alireza/My-files/uni/Practice/ZeroDCE++/Zero-DCE_extension-main/Zero-DCE++/data/inv_bri_comp_col_ratio_exp6_8layer_best_number1/DICM/ --read_subfolder True
